        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
              <h2 className="text-sm title-font text-gray-500 tracking-widest">{params.linea === 'lineaOmega' ? 'Línea Omega' : params.linea === 'lineaGRG' ? 'Línea GRG' : params.linea === 'lineaSalud' ? 'Línea Salud' : '404'}</h2>
