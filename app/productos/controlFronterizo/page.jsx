...
const objeto = {
  ...
  "tdn" : false,
  "parrafo" : true,
  "caracteristicas" : ["El Sistema Ω-47-ABC es una solución que integra el hardware necesario y el más sofisticado software.","Sabemos lo importante que es hoy agilizar los procesos en el lobby de migración de los puestos fronterizos, puertos y aeropuertos, sin perder los altos niveles de seguridad. También el factor estratégico de abrir nuevas bocas de acceso internacional al país para facilitar el desarrollo económico regional, poder aumentar a bajo costo, la capilaridad y la accesibilidad del sistema migratorio a fin de agilizar los accesos.", "Cualquiera de los modelos de este producto, pueden utilizarse en los distintos puestos de ingreso al país. La ventaja de operar las 24 hs. los 7 días de la semana sin requerir de RRHH adicionales, convierte a esta solución en una herramienta extraordinaria para poder realizar una migración rápida y segura.", "El sistema, recopila, analiza y provee información inteligente acerca de la identidad y movimientos de los migrantes entrantes y salientes para facilitar la toma de decisiones en la prevención de ilícitos.", "El sistema cuenta con funciones de identificación de las personas y su documentación de viaje o tránsito.", "Consulta y alerta contra listas de impedimentos locales y de interpol." ],
