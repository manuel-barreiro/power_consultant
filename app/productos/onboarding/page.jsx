...
export const metadata = {
  title: "Onboarding",
  description:
    "El proceso de onboarding con validación de identidad y reconocimiento facial combina la verificación de documentación y la identidad de una persona con la tecnología de reconocimiento facial para asegurar que la persona que se registra es quien dice ser.",
  openGraph: {
...
export default function page() {
  const objeto = {
    ...
    caracteristicas: [
      "El proceso de onboarding con validación de identidad y reconocimiento facial combina la verificación de documentación y la identidad de una persona con la tecnología de reconocimiento facial para asegurar que la persona que se registra es quien dice ser.",
      "Este novedoso sistema de IA que permite realizar validaciones fidedignas de rostro y documentación, y consecuentemente genera registros altamente confiables de acreditación de las personas.",
      ...
      "Nuestro Ω-47-IDENTIDAD respeta las normas que son las que riegen hoy los controles de calidad en el proceso de reconociendo facial. A su vez la calidad de imagen se ayorna al las exigencias del informe técnico para la toma de la imagen.",
      "Nuestra tecnología de reconocimiento facial se encuentra instalada en el la NASA, el FBI y el departamento de estado de los EEUU.",
    ],
    isPdf: "",
    isVideo: "",
  };
