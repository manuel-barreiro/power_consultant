                ...
                <div className="flex flex-wrap -m-2">
                    ...
                    <div className="p-2 w-1/2">
                        <div className="relative">
                            ...
                            <input type="text" id="empresa" name="empresa" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-primaryOrange focus:bg-white focus:ring-2 focus:ring-primaryOrange/50 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out h-8"/>
                        </div>
                    </div>
                    <div className="p-2 w-1/2">
                        <div className="relative">
                            <label htmlFor="telefono" className="leading-7 text-sm text-gray-600">Teléfono</label>
                            <input type="text" id="telefono" name="telefono" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-primaryOrange focus:bg-white focus:ring-2 focus:ring-primaryOrange/50 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out h-8"/>
                        </div>
                    </div>
