    ...
    <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
      <Link href={`${cat}/${urlName}`}>
          ...
          <div className="px-4 py-3 w-72 flex flex-col gap-5">
              ...
              <button className="px-4 py-2 mt-1 w-full rounded-md md:text-xs text-white bg-gradient-to-tr from-neutral-900 to-neutral-500 hover:scale-105 ease-in-out duration-300">Ver Producto</button>
          </div>
      </Link>
    </div>
  )
